...
Check the results of these exercises by re-running the edited code chunk and re-knitting the whole notebook.

1. Duplicate the code chunk of one of the figures in your notebook (remember to rename it if necessary) and use the `fig.asp` figure option to set its aspect ratio to be square, i.e., 1:1.

2. Use the `fig.align` option on the above figure to centre it on the page.

3. On a fresh duplicate of the original figure, use `fig.dim` to resize the figure to a width of 4 inches and height of 6 inches.
